...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Aarambh Resource Management Solutions — Learning & Development Consulting" },
      {
        name: "description",
        content:
          "L&D consulting practice helping organisations build capability through instructional design, digital learning, facilitation, experiential programs and AI-enabled workflows.",
      },
      { name: "author", content: "Aarambh Resource Management Solutions" },
      { property: "og:site_name", content: "Aarambh Resource Management Solutions" },
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/02a792b7-a835-4d61-b9b4-d85a12928e59/aarambh-preview.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/02a792b7-a835-4d61-b9b4-d85a12928e59/aarambh-preview.png" },
    ],
    links: [
